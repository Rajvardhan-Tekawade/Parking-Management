...
const SignUpUser = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    setError(null);
    console.log("Form data for user signup:", data);
    
    try {
      // Sign up with explicit user role
      const result = await signUp(data.email, data.password, data.name, 'user');
        ...
        <Card className="border-none shadow-lg">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Sign up to find and reserve parking spaces
            </CardDescription>
          </CardHeader>
